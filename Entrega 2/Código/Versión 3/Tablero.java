...
private void leerArchivo() {
    ...
    while (i < archivo.length) {
        ...
        if (linea.charAt(0) == 'P') {
            ...
            Posicion posicionfantasma = new Posicion(filaF,colF);
            tablero[posicion.fila][posicion.col].caracter = juego.pacman;
            juego.fantasma = new Fantasma(Caracter.FANTASMA, posicionfantasma, 'Ə');
            tablero[filaF][colF].caracter = juego.fantasma;
    ...
    while(allG){
        ...
        int z = getRandom(0, 1);
            ...
            if(x<15 && y <15){
                ...
                tablero[x][y] = new Celda(false,false,true,false,null);
                cantidadG++; 
                }
